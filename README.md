# MusiWeb
MusiWeb is a VLC inspired music player in a website, and is very mod-friendly through plugins.\
...
## Running MusiWeb locally

Install requirements:
```
npm i express http path fs prompt-sync
```
Run:
```
node server.js
...
Please see the Wiki on this GitHub Repo for infomation about Plugins.